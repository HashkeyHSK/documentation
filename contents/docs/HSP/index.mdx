...
description: A self-contained introduction for hackathon developers — what HSP is, what you can build, the tools you get, and how to send your first payment.
---
...
**HSP (HashKey Settlement Protocol)** is a verifiable settlement layer for
...
- `<REPO_URL>` — the SDK repository
- `<COORDINATOR_URL>` — the hosted sandbox Coordinator
- `<API_KEY>` — your per-team write key
